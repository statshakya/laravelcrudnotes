    ...
    <div class="container mx-auto px-4">
        ...
        <div class="p-5 bg-amber-200 rounded-lg shadow-md group">
            ...
            <!-- Make textarea fill the available space -->
                <input type="text" name="title" value=" {{$note->title}}" class="w-full text-cyan-800 p-5 bg-teal-400 rounded mb-4" placeholder="Please enter your title here"/>
                <textarea name="note" class="w-full h-32 text-cyan-800 p-5 bg-teal-400 rounded mb-4" placeholder="Please enter your notes here">{{$note->note}}
                </textarea>
